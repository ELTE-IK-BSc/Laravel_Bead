...
@section('content')
    <div class="bg-clip-content bg-no-repeat bg-center"
        style="background-image: url('{{ asset('storage/' . Place::findOrFail($contest->place_id)->imagename_hash) }}')">

        <h1 class="w-full text-center text-xl">
            {{ Place::findOrFail($contest->place_id)->name }}
        </h1>
        @isset($contest->win)
            <h1 class="w-full text-center text-xl">
                @if ($contest->win)
        ...
        <div class="flex justify-evenly">
            <table class="table table-pin-rows max-w-fit bg-gray-100 dark:bg-gray-600">
            ...
            <div class="max-w-80 bg-gray-100 dark:bg-gray-600">
                <h1>History</h1>
